...
<thead>
  ...
  <tbody>
                {songs.map(song => (
                    ...
                    <tr style={{height:'80px',marginBottom:'200px !important'}}  key={song.song_id || ""} className="song-card" onClick={() => handleSongClick(song.song_id)}>
                        <td><img
                      ...
                      <td style={{width:'250px'}} > <p>{song.album.artist.name || 'Unknown Artist'}</p></td>
