...
const ChatPage = () => {
   ...
   const onPrivateMessage = (payload) => {
      ...
      } else {privateChats.set(payloadData.senderName, [payloadData]);
      }
      setPrivateChats(new Map(privateChats));
   };
   ...
   // chat private
   const sendPrivate = () => {
      if (!stompClient.current || !connected.current) {console.error("WebSocket chưa được kết nối!");
         return;
      }
      ...
      <div style={{height:'92vh'}} className="flex items-center justify-center w-[100%] chatpage">
         <div className="flex w-full h-full">
            ...
            <div className="flex flex-col p-3 w-[50%] h-[100vh] bg-transparent chatpa ">
               ...
               {/* </ul> */}
            </div><div className="flex flex-col w-[60%] mt-3 chatbox hihi">
               {/* Chat Box */}
               <div
                  ...
                  {tab === "CHATROOM"
                     ...
                     : privateChats.get(tab)?.map((message, index) => (
                          ...
                          >
                             <div
                                className={`p-2 flex flex-col max-w-lg ${
                                   message.senderName !== username ? "bg-white rounded-t-lg rounded-r-lg"
